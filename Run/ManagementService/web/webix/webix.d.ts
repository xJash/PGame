...
declare module webix {
	...
	interface html {
		addCss(node: HTMLElement, name: string, b?: boolean): void;
	...
	function modalbox(params: string|any, callback?: WebixCallback): HTMLElement;
	...
	function type(config: any, data: any): void;
	...
	module ui {
		...
		interface datatable extends webix.ui.baseview {
			...
			getIndexById(id: string): number;
			getItem(id: string): any;
			getItemNode(id: string): HTMLDivElement;
			getLastId(): string;
			getNextId(id: string, step: number): string;
			getNode(): any;
			getPage(): number;
			...
			updateItem(id: string, data: any): void;
			updateItemValues(id: string, data: any): void;
			validate(id?: string): boolean;
			validateEditor(id?: string): boolean;
			$drag(source: HTMLElement, ev: Event): string;
			$dragHTML: WebixCallback;
