...
(function (t) {
    ...
    var r = function (e) {
        ...
        a.prototype._computeBezierCurve = function (t, e, a, r, i) {
            ...
            var H = 0;
            for (var y = 0, g = 0, b = 0, G = 0; y < e; y++, g += 3) {
                var D = h[y];
                m += D;
                var $ = m;
                if (f) {
                ...
                this.addCurvePosition($ * .1, O, S, E, M, B, C, w, I, l, g, a)
            }
        };
                    ...
                    if (e !== null) {
                        ...
                        if (this._armatureDisplay._batchEnabled) {
                            ...
                            if (t.isV5) {
                                ...
                                v.drawMesh(d._bitmapX, d._bitmapY, d._bitmapWidth, d._bitmapHeight, d._offsetX, d._offsetY, d.textureWidth, d.textureHeight);
                                v.imageWidth = d._sourceWidth;
                                v.imageHeight = d._sourceHeight
                            }
                            this._blendModeDirty = true;
                            this._colorDirty = true
                        }
                        ...
                        var y = e.weight !== null;
                        var g = this._parent._boneData.type !== 0;
                        if (y || g) {
                        ...
                        if (this._armatureDisplay._batchEnabled) {
                            ...
                            v.image = d.bitmapData;
                            if (t.isV5) {
                                v.drawImage(d.$bitmapX, d.$bitmapY, d.$bitmapWidth, d.$bitmapHeight, d.$offsetX, d.$offsetY, b, D);
                                v.imageWidth = d.$sourceWidth;
                                v.imageHeight = d.$sourceHeight
                            } else {
                                v.drawImage(d._bitmapX, d._bitmapY, d._bitmapWidth, d._bitmapHeight, d._offsetX, d._offsetY, b, D);
                                v.imageWidth = d._sourceWidth;
                                v.imageHeight = d._sourceHeight
                            }
                            this._blendModeDirty = true;
