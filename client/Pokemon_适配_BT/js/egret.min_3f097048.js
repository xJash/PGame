...
! function (t) {
    ...
    var i = function (i) {
        ...
        return __extends(r, i), r.prototype.createNativeDisplayObject = function () {
            ...
            var i = this;
            return e || i.$scrollRect ? (e ? (i.$scrollRect || (i.$scrollRect = new t.Rectangle), i.$scrollRect.copyFrom(e), t.nativeRender && i.$nativeDisplayObject.setScrollRect(e.x, e.y, e.width, e.height)) : (i.$scrollRect = null, t.nativeRender && i.$nativeDisplayObject.setScrollRect(0, 0, 0, 0)), void (t.nativeRender || i.$updateRenderMode())) : void i.$updateRenderMode()
            ...
            set: function (e) {
                var i = this,
                    r = i.$filters;
                return r || e ? (e && e.length ? (e = e.concat(), i.$filters = e, t.nativeRender && i.$nativeDisplayObject.setFilters(e)) : (i.$filters = e, t.nativeRender && i.$nativeDisplayObject.setFilters(null)), void (t.nativeRender || i.$updateRenderMode())) : (i.$filters = e, void (t.nativeRender ? i.$nativeDisplayObject.setFilters(null) : i.$updateRenderMode()))
            },
            enumerable: !0,
            configurable: !0
        ...
        }, r.prototype.$updateRenderNode = function () { }, r.prototype.$hitTest = function (t, e) {
            var i = this;
    ...
    var e = function (t) {
        ...
        return __extends(e, t), Object.defineProperty(e.prototype, "type", {
            ...
            if (n || (n = t.eventPool = []), n.length) {
                var a = n.pop();
                return a.$type = e, a.$bubbles = !!i, a.$cancelable = !!r, a.$isDefaultPrevented = !1, a.$isPropagationStopped = !1, a.$isPropagationImmediateStopped = !1, a.$eventPhase = 2, a
            }
            return new t(e, i, r)
...
! function (t) {
    var e = function (e) {
        ...
        return __extends(i, e), Object.defineProperty(i.prototype, "numChildren", {
            ...
            if (t.nativeRender) a.$nativeDisplayObject.addChildAt(e.$nativeDisplayObject.id, r);
            else if (e.$maskedObject && e.$maskedObject.$updateRenderMode(), !a.$cacheDirty) {
                a.$cacheDirty = !0;
                var l = a.$parent;
...
! function (t) {
    var e = function (e) {
        ...
        return __extends(i, e), i.prototype.createNativeDisplayObject = function () {
            ...
            return e == this.$fillMode ? !1 : (this.$fillMode = e, t.nativeRender && this.$nativeDisplayObject.setBitmapFillMode(this.$fillMode), !0)
...
! function (t) {
    ...
    var i = function (i) {
        ...
        return __extends(r, i), r.prototype.$setTarget = function (e) {
        ...
        }, r.prototype.beginGradientFill = function (e, i, r, n, a) {
        ...
        }, r.prototype.lineStyle = function (e, i, r, n, a, o, s, h, c) {
        ...
        }, r.prototype.drawRect = function (e, i, r, n) {
        ...
        }, r.prototype.drawRoundRect = function (e, i, r, n, a, o) {
        ...
        }, r.prototype.drawCircle = function (e, i, r) {
        ...
        }, r.prototype.drawEllipse = function (e, i, r, n) {
        ...
        }, r.prototype.curveTo = function (e, i, r, n) {
            e = +e || 0, i = +i || 0, r = +r || 0, n = +n || 0, t.nativeRender && this.$targetDisplay.$nativeDisplayObject.setCurveTo(e, i, r, n);
            var a = this.fillPath,
                o = this.strokePath;
            a && a.curveTo(e, i, r, n), o && o.curveTo(e, i, r, n), this.extendBoundsByPoint(e, i), this.extendBoundsByPoint(r, n), this.updatePosition(r, n), this.dirty()
        }, r.prototype.cubicCurveTo = function (e, i, r, n, a, o) {
            e = +e || 0, i = +i || 0, r = +r || 0, n = +n || 0, a = +a || 0, o = +o || 0, t.nativeRender && this.$targetDisplay.$nativeDisplayObject.setCubicCurveTo(e, i, r, n, a, o);
            var s = this.fillPath,
                h = this.strokePath;
            s && s.cubicCurveTo(e, i, r, n, a, o), h && h.cubicCurveTo(e, i, r, n, a, o), this.extendBoundsByPoint(e, i), this.extendBoundsByPoint(r, n), this.extendBoundsByPoint(a, o), this.updatePosition(a, o), this.dirty()
        }, r.prototype.drawArc = function (i, r, n, a, o, s) {
            if (!(0 > n || a === o)) {
...
! function (t) {
    ...
    function (t) {
        if (t.nativeRender = __global.nativeRender, t.nativeRender) {
            ...
            if (r > e) {
                t.nativeRender = !1;
                var n = "需要升级微端版本到 0.1.6 才可以开启原生渲染加速";
        ...
        var i = function (e) {
            ...
            return __extends(i, e), i.prototype.drawImage = function (t, e, i, r, n, a, o, s) {
                ...
                var A = h,
                    ...
                    U = L + d - j,
                    H = d - m - j;
                T > 0 && (x > 0 && e.drawImage(O, S, x, T, A, L, b, m), _ > 0 && e.drawImage(w, S, _, T, B, L, k, m), R > 0 && e.drawImage(E, S, R, T, N, L, M, m)), D > 0 && (x > 0 && e.drawImage(O, F, x, D, A, I, b, H), _ > 0 && e.drawImage(w, F, _, D, B, I, k, H), R > 0 && e.drawImage(E, F, R, D, N, I, M, H)), C > 0 && (x > 0 && e.drawImage(O, P, x, C, A, U, b, j), _ > 0 && e.drawImage(w, P, _, C, B, U, k, j), R > 0 && e.drawImage(E, P, R, C, N, U, M, j))
    ...
    var e = function (e) {
        ...
        return __extends(i, e), i.prototype.drawToTexture = function (e, i, r) {
            ...
            if (s.resize(a, o), this.$bitmapData.width = a, this.$bitmapData.height = o, t.nativeRender) {
                ...
                d.identity(), i && d.translate(-i.x, -i.y), d.scale(r, r), t.sys.systemRenderer.render(e, s, d, !0), t.Matrix.release(d)
            }
        ...
        T = function () {
            ...
            return n.prototype.render = function (e, i, r, n) {
                ...
                if (c && (!c.$children || 0 == c.$children.length) && u && 3 == u.type && 1 == u.drawData.length && 1 == u.drawData[0].type && 1 == u.drawData[0].fillAlpha) {
                    ...
                    var p = t.Matrix.create();
                    p.copyFrom(c.$getConcatenatedMatrix()), c.$getConcatenatedMatrixAt(e, p), i.transform(p.a, p.b, p.c, p.d, p.tx, p.ty);
...
! function (t) {
    ...
    var i = function () {
        function e() { }
        return e.language = "zh-CN", e.os = "Unknown", e.runtimeType = t.RuntimeType.WEB, e.engineVersion = "5.2.3", e.renderMode = "Unknown", e.boundingClientWidth = 0, e.boundingClientHeight = 0, e
    }();
    ...
    var i = new RegExp("(?=[\\u00BF-\\u1FFF\\u2C00-\\uD7FF]|\\b|\\s)(?![。，！、》…）)}”】\\.\\,\\!\\?\\]\\:])"),
        r = function (r) {
            ...
            return __extends(n, r), n.prototype.createNativeDisplayObject = function () {
                ...
                set: function (e) {
                    this.$TextField[28] = Math.max(e, 1), t.nativeRender && this.$nativeDisplayObject.setScrollV(e), this.$invalidateTextField()
                },
                enumerable: !0,
                configurable: !0
                ...
                return this.$TextField[30] = e, this.$invalidateTextField(), t.nativeRender && this.$nativeDisplayObject.setMultiline(e), !0
