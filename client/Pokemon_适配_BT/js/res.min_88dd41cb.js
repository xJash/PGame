...
! function(e) {
    var t = function(t) {
        ...
        }, r.prototype.loadFile = function(e, t, r) {}, r.prototype.getRes = function(e) {}, r.prototype.destroyRes = function(e) {
            return !1
...
! function(e) {
    var t = function(t) {
        ...
        }, r.prototype.onResourceDestroy = function(e) {}, r
    }(e.AnalyzerBase);
...
! function(e) {
    ...
    e.ResourceItem = t, __reflect(t.prototype, "RES.ResourceItem")
}(RES || (RES = {}));
var RES;
! function(e) {
    var t = function(t) {
...
! function(e) {
    var t = function(t) {
        ...
        return __extends(r, t), r.prototype.isGroupInLoading = function(e) {
            ...
            for (var i, n = r.length, o = 0; n > o && (this.queueIndex >= n && (this.queueIndex = 0), i = this.itemListDic[r[this.queueIndex]], !(i.length > 0)); o++) this.queueIndex++;
            ...
            if (e) {
                ...
                if (r)
                    for (var i = r.length, n = 0; i > n; n++) {
                        var o = r[n],
                            s = o.url;
                        s && -1 == s.indexOf("://") && (o.url = t + s), this.addItemToKeyMap(o)
                    }
                var a = e.groups;
                if (a)
...
! function(e) {
    ...
    e.ResourceEvent = t, __reflect(t.prototype, "RES.ResourceEvent")
}(RES || (RES = {}));
var RES;
! function(e) {
    var t;
    ! function(t) {
        ...
        t.Html5VersionController = r, __reflect(r.prototype, "RES.web.Html5VersionController", ["RES.VersionController", "RES.IVersionController"]), e.VersionController = r
    }(t = e.web || (e.web = {}))
}(RES || (RES = {}));
var RES;
! function(e) {
    var t = function(e) {
        ...
        return __extends(t, e), t.prototype.analyzeConfig = function(e, t) {
            ...
            var r = "",
                ...
                n = i[2],
                o = n.indexOf('file="');
            return -1 != o && (n = n.substring(o + 6), o = n.indexOf('"'), r = n.substring(0, o)), e = e.split("\\").join("/"), o = e.lastIndexOf("/"), e = -1 != o ? e.substring(0, o + 1) + r : r
    ...
    var t = function(t) {
        ...
        return __extends(r, t), r.prototype.onLoadFinish = function(e) {
            ...
            for (var i, n = Object.keys(t.mc), o = t.mc[n[0]].frames, s = o.length, a = [], u = 0; s > u; u++) {
                ...
                c.$bitmapData = e, c.$initData(i.x, i.y, i.w, i.h, o[u].x, o[u].y, o[u].sourceW, o[u].sourceH, e.width, e.height)
            }
            return a
        }, r.prototype.destroyRes = function(e) {
            var t = this.fileDic[e];
