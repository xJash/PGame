                ...
                },
                {
                    ...
                    cols: [
                        ...
                        },
                        {
                            ...
                            label: "创建",
                            width: 100,
                            click: addActivityConfig
                        },
                        {
                            view: "button",
                            label: "导出",
                            width: 100,
                            click: loadActivityConfigs
                        },
                    ]
                },

                {
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            header: "应用",
                            width: 60,
                            template: "<button class='apply'>应用</button>"
                        },
                        {
                            id: "check",
                            header: "勾选",
