  ...
  data: [
    {
      ...
      icon: "user",
      value: "玩家",
      include: [UserType.运维操作, UserType.联运操作, UserType.GM客服, UserType.只读用户, UserType.发行人员],
      data: [
        {
          id: "playerInfo",
          value: "玩家信息",
		...
		},
    {
      ...
      icon: "money",
      value: "充值",
      include: [ /*UserType.运维操作, */ UserType.联运操作, UserType.发行人员],
      data: [
        {
          id: "rechargeQuery",
          value: "充值查询"
		...
		},
    {
      ...
      icon: "envelope",
      value: "邮件",
      include: [UserType.运维操作, UserType.联运操作 /*, UserType.GM客服*/ ],
      data: [
        {
          id: "mailQuery",
          value: "邮件查询"
		...
		},
    {
      ...
      icon: "ban",
      value: "封禁",
      include: [UserType.运维操作, UserType.联运操作, UserType.GM客服, UserType.发行人员],
      data: [
        {
          id: "banQuery",
          value: "封禁管理"
...

    {
      ...
      data: [
        ...
        {
          id: "serverPlayerCountStatistics",
          value: "区服玩家人数统计"
        },
			]
        },
    {
      ...
      icon: "search",
      value: "SQL查询",
      include: [ /*UserType.运维操作,*/ UserType.Operator],
      data: [
        {
          id: "sqlQuery",
          value: "SQL查询"
        ...
        },
    {
      ...
      icon: "server",
      value: "游戏服",
      include: [UserType.Operator /*, UserType.账户管理员*/ ],
      data: [
        {
          id: "serverManage",
          value: "游戏服管理"
        ...
        },
    {
      ...
      icon: "server",
      value: "开服计划",
      include: [UserType.运维操作, UserType.联运操作],
      data: [
        {
          id: "serverOpen",
          value: "开服计划"
    ...
    rows: [
      {
        ...
        elements: [
          {
            view: "label",
            template: "<div class='title'>xulong游戏后台运维管理系统</div>"
          },
          {
            view: "label",
            id: "userLabel",
